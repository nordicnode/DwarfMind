...
| `build_layer` | Spatial planning | Scans terrain in round-robin windows, generates dig blueprints (workshop block, residential nodes, stockpile, admin hall) anchored on the embark wagon, issues dig designations, and queues furniture construction — all gated by `dry_run`. |
